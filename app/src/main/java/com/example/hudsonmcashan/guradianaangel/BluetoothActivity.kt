...
class BLEDeviceSimple(name, address) {
  val name = name
  val address = address
}
...
//  val parent: PApplet
  ...
  lateinit var scanCallback: BleUARTScanCallback
  lateinit var uartGatt: BleUARTGatt
  ...
  lateinit var parentMethodDeviceDiscovered: Method
  lateinit var parentMethodScanningFinished: Method
  lateinit var parentMethodConnected: Method
  lateinit var parentMethodDisconnected: Method
  lateinit var parentMethodMessageReceived: Method

  lateinit var stopScanTimer: Timer

  //protected BLEDeviceMap deviceMap;
  lateinit var deviceMap: HashMap<String, BluetoothDevice>

  var targetMacAddress = null
...
//  }
  ...
  init {
    ...
    isInit = true
    Log.i(TAG_BEACON, "BleUART.init(): initialized")
    printlnDebug);
  }
  ...
  ArrayList<BLEDeviceSimple> getDeviceList() {
   ...
   fun getScanResult(int i) -> BLEDeviceSimple {
